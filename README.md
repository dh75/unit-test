...
- **JSON / CSV 내보내기** — 생성된 TC를 JSON 복사, JSON 파일 저장, 또는 CSV 파일로 저장
...
5. **분석 실행** 버튼 클릭
6. 생성된 테스트케이스 확인 후 **JSON 복사**, **JSON 저장** 또는 **CSV** 버튼으로 내보내기
...
- **`sidepanel.js`** — 소스 목록 관리, 분석 실행, TC 렌더링, JSON 복사/파일 저장/CSV 내보내기
